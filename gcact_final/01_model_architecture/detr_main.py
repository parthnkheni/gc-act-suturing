# detr_main.py  -- Model Builder
# Entry point that assembles the full ACT model from its components (backbone,
# transformer, VAE encoder). Called by policy.py when initializing the model.
# Sets all the hyperparameters (number of layers, hidden dimensions, etc.)
# and returns a ready-to-use model + optimizer.
# Originally from Facebook's DETR object detection codebase, adapted for ACT.
