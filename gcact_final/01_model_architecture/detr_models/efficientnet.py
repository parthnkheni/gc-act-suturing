# efficientnet.py  -- EfficientNet-B3 Backbone
# A more powerful image feature extractor than ResNet-18. Used in ACT v2 and
# GC-ACT. EfficientNet-B3 produces richer visual features from the camera
# images, which helps the model better understand the surgical scene (needle
# position, tissue state, arm locations). Pretrained on ImageNet, then
# fine-tuned during ACT training.
