...
# The core attention mechanism of ACT. The encoder processes the camera
# features (what the robot sees) and the decoder generates action sequences
# (what the robot should do). Uses multi-head self-attention to relate
# different parts of the visual scene to each other and cross-attention to
# connect visual observations to motor actions. This is the same type of
# architecture used in large language models, adapted for robot control.
