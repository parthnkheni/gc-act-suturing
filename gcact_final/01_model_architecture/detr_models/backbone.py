# backbone.py  -- Image Feature Extractor
# The "eyes" of the model. Takes raw camera images (from the endoscope and
# wrist cameras) and extracts visual features that the transformer can process.
# Supports two backbone networks:
#   - ResNet-18: smaller, used in ACT v1
#   - EfficientNet-B3: larger and more accurate, used in ACT v2 and GC-ACT
# Originally from Facebook's DETR, extended with EfficientNet support.
