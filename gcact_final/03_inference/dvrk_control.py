# dvrk_control.py  -- da Vinci Robot Arm Controller
# Low-level interface to the physical da Vinci robot arms (PSM1 and PSM2).
# Handles homing the arms, sending position/rotation commands, and reading
# back the current arm state. Uses the dVRK CRTK (Common Robot Teleoperation
# Kit) API over ROS. Called by the inference scripts to actually move the robot.
