#!/usr/bin/env python3
# generate_architecture_diagram.py  -- Paper Figure: Model Architecture
# Generates the GC-ACT architecture diagram used in the paper. Shows the
# data flow: camera images -> backbone -> transformer -> action chunks, with
# the gesture classifier feeding into the transformer as our novel addition.
# Outputs a PDF figure ready for inclusion in the LaTeX paper.
